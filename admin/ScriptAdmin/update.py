...
OPERATIONS = ["sudo -S apt-get update","sudo -S apt-get -y upgrade"]

# initilisation du client
client = paramiko.SSHClient()
client.set_missing_host_key_policy(paramiko.AutoAddPolicy())

print(f'===== Mise à jour automatique sur {NBHOST} machines =====')
...
for h in HOSTNAME:
    try:
        ...
        print('> Lancement de la mise à niveau')
        for op in OPERATIONS:
            ...
            if err:
                print(err)
        print(f'> Mise à niveau terminée sur {h}')
    except:
