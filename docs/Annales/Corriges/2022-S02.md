...
!!! Commentaire
        ...
        qui sert de base à la construction de la $k-ième$ à partir de la ligne précédente dans l'exercice ci-dessus. On peut d'ailleurs signaler que la génération des coefficients binomiaux est des algorithmes prévus au programme de terminale en spécialité mathématiques.
